<<<<<<< HEAD:WebContent/view/EvaluationsEtudiants.jsp
...
<!--   <div class="container"> -->
<!--    <p> Application de gestion d'apprentissage par projet </p> -->
<!--  </div> -->
<!-- </div> -->
 </body>
</html>
...
<%@include file="Header.jsp" %> </div>
  ...
  <ul class="nav nav-tabs nav-justified">
    ...
    <li class="active" ><a data-toggle="tab" href="#home">Grille de compétences</a></li>
...
>>>>>>> origin/Yannis:WebContent/view/Evaluation.jsp
</html>